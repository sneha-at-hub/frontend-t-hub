  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-50 to-blue-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto">
        <h3 className="text-4xl font-bold mb-6 text-slate-900">Colors</h3>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-slate-500 text-sm">Loading colors...</p>
            </div>
          ) : colors.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              <p className="text-slate-600 text-sm">No colors yet.</p>
            </div>
          )}
        </div>
      </div>
